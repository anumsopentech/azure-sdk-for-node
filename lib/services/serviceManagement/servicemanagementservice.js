...
* @param {bool}   stayProvisioned       Whether to keep the VM in provisioned state or not. Required.
* @param {function} callback            The callback function called on completion. Required.
*/
ServiceManagementService.prototype.shutdownRole = function (serviceName, deploymentName,
                                                      roleInst, stayProvisioned, callback) {
  ...
  var webResource = WebResource.post(path);
  var outbody = this.serialize.buildShutdownRole(serviceName, deploymentName, stayProvisioned,
                                                roleInst, this);
